...
import { setToLoggedIn, setUserTo } from '../features/redux/user/userSlice';
import { login, registration } from '../http/userAPI';
import { HOME_ROUTE, LOGIN_ROUTE, REGISTRATION_ROUTE } from '../lib/utils/routes';
